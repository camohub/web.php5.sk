...
[],n=0;e(this).children("li").each(function(){var m=e(this),c={},k=m.attr("id");if(!k)throw console.log(m),"Previous item in console.log has no id. It is necessary to create the array.";c.id=k;c.value=m.data("value");c.order=n;g.push(c);c.children=m.children("ul,ol").sortableListsToHierarchy();n++});return g};e.fn.sortableListsToString=function(g,n){g=g||[];n=n||"no-parent";e(this).children("li").each(function(){var m=e(this),c=m.attr("id"),c=c?c.match(/[0-9]+/):null;if(!c)throw console.log(m),"Previous item in console.log has no id or has no number in id attribute. It is necessary to create valid string.";
c=c[0];g.push("sItems["+c+"]="+n);e(this).children("ul,ol").sortableListsToString(g,c)});return g.join("&")}})(jQuery);
